import {keywordContext} from './report-growth.mjs?v=20260911-visual';
...
import {acosDisplay,sourceDateRange} from './report-display.mjs?v=20260911-visual';
import {moduleSource,mountModules} from './report-modules.mjs?v=20260911-visual';
import {actionTone} from './report-reading.mjs?v=20260911-visual';
...
function thumbnail(source){
 ...
 const pending=el('span','thumbnail-loading','加载中'),img=el('img');img.width=44;img.height=44;img.alt=source.getAttribute('alt')||'商品主图';img.loading='lazy';img.referrerPolicy='no-referrer';
