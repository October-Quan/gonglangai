...
import {moduleSource,mountModules} from './report-modules.mjs?v=20260909-modules';
...
export function renderReport(html,host,meta,note,ownAsin=''){
 const fragment=window.DOMPurify.sanitize(html,{RETURN_DOM_FRAGMENT:true,ALLOWED_TAGS:['h1','p','div','table','thead','tbody','tr','th','td','br','hr','img'],ALLOWED_ATTR:['src','alt','width','height','scope','data-report-format','data-module-panel','data-module-state'],ALLOW_DATA_ATTR:false,FORBID_TAGS:['style','script','iframe','form','input','svg','math']});
 ...
 if(master)mountModules(meta,host.closest('#report-panel'));
