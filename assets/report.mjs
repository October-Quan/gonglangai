...
import {moduleSource,mountModules} from './report-modules.mjs?v=20260910-competitors';
...
export function renderReport(html,host,meta,note,ownAsin=''){
 ...
 if(master)mountModules(meta,host.closest('#report-panel'),fragment.querySelector('[data-module-panel="02"][data-module-state="ready"]'),thumbnail,fragment.querySelector('[data-module-panel="03"][data-module-state="ready"]'),fragment.querySelector('[data-module-panel="04"][data-module-state="ready"]'));
